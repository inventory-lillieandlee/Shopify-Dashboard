...
function stats(s: Summary): Stat[] {
  return [
    ...
    { label: "Yellow", value: s.yellow, sub: "plan ahead · DSR ≤ 150", icon: TriangleAlert, tone: "text-amber-600" },
    { label: "Red", value: s.red, sub: "act now · DSR ≤ 90", icon: CircleAlert, tone: "text-red-600" },
    { label: "Critical", value: s.critical, sub: "overdue / DSR ≤ 45 / spike", icon: OctagonAlert, tone: "text-red-700" },
    { label: "Spiking", value: s.spiking, sub: "≥ 15% above plan", icon: TrendingUp, tone: "text-fuchsia-600" },
  ];
}
